...
- [x] Refonte editoriale de la carte produit (`components/shop/product-card.tsx`) - jugee "banale/archaique" (grille e-commerce generique, photo carree, badge prix flottant, nom de boutique en petit texte gris)
  ...
  - Fix (2026-07-27) : titre sur 1 vs 2 lignes decalait differemment le nom de boutique et le prix d'une carte a l'autre sur la meme rangee (repere en conditions reelles apres deploiement) - hauteur de titre desormais fixe (2 lignes reservees, `line-clamp-2`).
